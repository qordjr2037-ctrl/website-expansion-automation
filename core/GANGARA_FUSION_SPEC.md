...
| pool_total | 38 |
| board_urls | 0 |
| Tier S | 1 (roompang directory P0) |
| Tier A | 9 (guide_hub·profile) |
| Tier B | 10 (web2·landing) |

**키워드 coverage (queued):**
- 강남 가라오케: 6 · 강남 풀싸롱: 3 · 강남 하이퍼블릭: 7 · 강남 유흥: 3 · 강남 클럽: 1

**P0 후보:** `https://roompang.com/` (directory, trait 100)

---

## 5. gangara RD 추이 (실측 2026-06-17)
